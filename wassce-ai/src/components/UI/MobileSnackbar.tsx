...
export default function MobileSnackbar() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-30 sm:hidden pb-[env(safe-area-inset-bottom)]" role="status" aria-live="polite">
      <div className="rounded-2xl border border-slate-800 bg-slate-950/95 px-3 py-2 text-slate-100 shadow-2xl backdrop-blur">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex flex-col items-center gap-1 rounded-xl px-2 py-2 transition ${
                  isActive ? "bg-indigo-500/20 text-indigo-100" : "text-slate-300 hover:bg-slate-900/70"
                }`
              }
